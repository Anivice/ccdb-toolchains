...
ENTRY(_start)
SEARCH_DIR("=/opt/x-tools/i586-unknown-linux-musl/i586-unknown-linux-musl/lib64"); SEARCH_DIR("=/usr/local/lib64"); SEARCH_DIR("=/lib64"); SEARCH_DIR("=/usr/lib64"); SEARCH_DIR("=/opt/x-tools/i586-unknown-linux-musl/i586-unknown-linux-musl/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
